//the core question: How to choose the pivot?
/*3 conditions to implement:
1. Correct position in final, sorted array
2. Items to the left are smaller
3. Items to the right are bigger
*/
//credit to Michael Sambol from Youtube: https://youtu.be/Hoixgm4-P4M
//and also to GeekforGeek
// TC best O(nlogn), avg O(nlogn), worst O(n^2)
//SC worst O(n), best O(logn) 
